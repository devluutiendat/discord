...
export default function NotFound() {
  return (
    <div className="flex flex-col text-black items-center text-center pt-24 md:text-justify md:flex-row md:items-center md:justify-center md:space-x-6 bg-backgroundCat w-full h-screen">
